  ...
  <Route component={MainContainer}>
    <Route
      ...
      getComponent={(route, cb) =>
        import(/* webpackChunkName: 'personal-form' */'./containers/main/personal-form.jsx')
    ...
    <Route
      ...
      getComponent={(route, cb) =>
        import(/* webpackChunkName: 'complete-form' */'./containers/main/complete-form.jsx')
          .then(page => page.default)
    ...
    <Route
      ...
      getComponent={(route, cb) =>
        import(/* webpackChunkName: 'bank-form' */'./containers/main/bank-form.jsx')
          .then(page => page.default)
